...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__ (2),
			...
			LeftNav = __webpack_require__ (163),
			PubSub = __webpack_require__ (162),
			BannerImg = __webpack_require__ (164),
			IndexSearch = __webpack_require__ (165),
			HosList = __webpack_require__ (168),
			LoadMore= __webpack_require__ (170),
			UGround = __webpack_require__ (171),
		...
		render:function(){
			return (
					React.createElement("div", {className: "clearfix"}, 
						...
						React.createElement("div", {className: "container", onTouchEnd: this.toggleNav}, 
							React.createElement(Header, {ic: ""}, "优孕行"), 
							React.createElement(BannerImg, {zrc: "./images/banner2.jpg"}), 
							React.createElement(IndexSearch, {title: "我们只推荐最适合您的医院"}), 
							React.createElement("div", {className: "hos-list-box"}, 
								React.createElement("h5", {className: "hos-title t-center"}, "国际知名辅助生殖机构"), 
								React.createElement(HosList, null), 
								React.createElement(LoadMore, {href: "./hospitals.html?age=35", text: "查看更多"})
							), 
							React.createElement(UGround, null), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var 	PubSub = __webpack_require__ (162),
	...
	module.exports=React.createClass({displayName: "module.exports",
	  	...
	  	render:function(){
	    	...
	    	return (
	    			React.createElement("div", {className: "u-header"}, 
	    				React.createElement("a", {href: "javascript:history.go(-1);", className: back}, React.createElement("img", {src: "images/icon_back.png", style: {width:11,height:'auto',marginTop:1}})), 
	    				React.createElement("a", {href: "./index.html", className: homes}, React.createElement("img", {src: "images/icon_share.png", style: {width:20,height:'auto',marginTop:'-1px'}})), 
	    				React.createElement("div", {className: nav, onClick: this.showNav}, React.createElement("span", null), React.createElement("span", null), React.createElement("span", null)), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports=React.createClass({displayName: "module.exports",
	  ...
	  componentWillUnmount: function () {
		...
		render:function(){
			return(
				React.createElement("div", {className: "leftNav", style: {width:this.state.width}}, 
						React.createElement("div", {className: "redLine"}), 
						React.createElement("img", {src: "./images/uyx_nav_banner.png"}), 
						React.createElement("ul", {className: "nav-head"}, 
							React.createElement("li", null, React.createElement("a", {href: "./index.html"}, "首页-推荐医院")), 
							React.createElement("li", null, React.createElement("a", {href: "./guides.html"}, "就医指南")), 
							React.createElement("li", null, React.createElement("a", {href: "./news.html"}, "前沿资讯")), 
							React.createElement("li", {style: {borderBottom:'1px solid #ccc',marginBottom:20}}), 
							React.createElement("li", {className: "hide"}, React.createElement("a", {href: "./hospitals.html", style: {color:'red'}}, "常见问题")), 
							React.createElement("li", {className: "hide"}, React.createElement("a", {href: "./hospital.html", style: {color:'red'}}, "关于优孕行")), 
							React.createElement("li", {className: "hide"}, React.createElement("a", {href: "./active.html", style: {color:'red'}}, "媒体报道"))
						)
				)
			)
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports=React.createClass({displayName: "module.exports",
		render:function(){
			return (
					React.createElement("div", {className: "bannerboxz"}, 
						React.createElement("a", {href: "./active.html"}, 
						React.createElement("img", {src: this.props.zrc, className: "bannerImg"})
						)
					)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__ (2),
			Searchinp = __webpack_require__ (166);
	module.exports=React.createClass({displayName: "module.exports",
			render:function(){
				return (
					React.createElement("div", {className: "searchBox"}, 
						React.createElement("p", null, this.props.title), 
						React.createElement(Searchinp, {btnText: "智能推荐", pleacHolder: "请输入女士的年龄"})
					)
				)
			}
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $_GET = __webpack_require__ (167),
			React = __webpack_require__ (2);
	module.exports=React.createClass({displayName: "module.exports",
		getInitialState:function(){
				return {
		...
		render:function(){
			return (
					React.createElement("form", {action: "./hospitals.html", method: "get", onSubmit: this.handleCheackForm}, 
					React.createElement("input", {placeholder: this.props.pleacHolder, name: "age", value: this.state.age, onChange: this.handleChange, type: "text"}), 
					React.createElement("button", {type: "submit"}, this.props.btnText)
					)
			)
		}
	  ...
	  GetQueryString:function (name){
		...
		render:function(){
			return (
	          ...
	          return(
	          	React.createElement("div", {className: "hos-item", key: i}, 
	          		React.createElement("a", {href: href}, 
	          		React.createElement("img", {src: img_src}), 
	          		React.createElement("p", null, React.createElement("i", {className: "icon_location"}), React.createElement("span", null, item.city)), 
	          		React.createElement("div", null, 
	          			React.createElement("p", null, item.name_abbr), 
	          			React.createElement("p", {className: "ft12"}, item.summary)
	          		)
	          		)
	          	)
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports=React.createClass({displayName: "module.exports",
		render:function(){
			return (
				React.createElement("div", {className: "foot-grounp clearfix"}, 
						React.createElement("div", {className: "big-icon-guide"}, 
							React.createElement("a", {href: "./guides.html"}
							)
						), 
						React.createElement("div", null, 
							React.createElement("div", {className: "small-box-grounp"}, 
								React.createElement("div", {className: "small-icon-jyzx"}, 
									React.createElement("a", {href: "./news.html"}
									)
								), 
								React.createElement("div", {className: "small-icon-about"}, 
									React.createElement("a", {href: "./guides.html"}
									)
								)
							)
