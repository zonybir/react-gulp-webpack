...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__ (2),
			...
			Footer = __webpack_require__ (163),
			LeftNav = __webpack_require__ (164),
			PubSub = __webpack_require__ (162),
			NewsItem = __webpack_require__ (165);
		...
		render:function(){
			return (
					React.createElement("div", null, 
						...
						React.createElement("div", {className: "container", onClick: this.toggleNav}, 
							React.createElement(Header, {ic: ""}, "前沿资讯"), 
							React.createElement(NewsItem, null), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports=React.createClass({displayName: "module.exports",
		...
		render:function(){
				return (
						React.createElement("div", {onScroll: this.handleLoadMore, style: {height:800,overflow:'scroll'}, id: "outBoxNews"}, 
							this.state.d.map(function(val,key){
									var href='./news_detail.html?id='+val.id;
									return (
											React.createElement("div", {className: "news-list", key: val.id}, 
												React.createElement("a", {href: href}, 
													React.createElement("img", {src: val.img}), 
													React.createElement("p", null, val.title), 
													React.createElement("div", null, val.summary)
												)
											)
									)
							})
